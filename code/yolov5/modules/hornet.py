"""HorNet-attention block (gnconv) + C3HB wrapper, used by yolov5l_C3HB.yaml.

Adapted from iscyy/yoloair (https://github.com/iscyy/yoloair), itself based
on HorNet (https://ar5iv.labs.arxiv.org/html/2207.14284).

Drop into a stock yolov5 clone's models/common.py (or import from here and
register in models/yolo.py's parse_model), alongside the stock `Conv` class
